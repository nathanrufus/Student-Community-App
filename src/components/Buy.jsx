...
function Buy() {
    return <div className=" p-4 max-w-screen-2xl md:px-14 mt-20">
        <h1 className=" text-2xl text-blue-700 text-center mb-3">Enter payment details</h1>
        <form className="max-w-md mx-auto">
            ...
            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Buy Now</button>

        </form>
        <p className=" mt-10 text-sm text-center text-slate-500">Your will receive the details of your payment in your email address once the transaction has gone through.</p>
    </div>;
}
